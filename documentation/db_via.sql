...
CREATE TABLE `Immagine` (
  ...
  `CampagnaName` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `Utente` (
  ...
  PRIMARY KEY (`Name`),
  CONSTRAINT `LavoratoreLevelCheck` CHECK ((`LavoratoreLevel` in (_utf8mb4'alto',_utf8mb4'medio',_utf8mb4'basso'))),
  CONSTRAINT `mailcheck` CHECK (regexp_like(`Email`,_utf8mb4'^(\\S+)\\@(\\S+).(\\S+)$')),
  CONSTRAINT `ManagerChecker` CHECK ((((`Ruolo` = _utf8mb4'Manager') and (`LavoratoreLevel` is null)) or ((`Ruolo` = _utf8mb4'Lavoratore') and (`LavoratoreLevel` is not null)))),
...
INSERT INTO `Utente` VALUES ('abc','123','123@qq.com','Manager',NULL),('manager','123','1234@qq.com','Manager',NULL),('word3','123','w3@qq,com','Lavoratore','medio'),('work','123','work@qq.com','Lavoratore','alto'),('work2','1234','work2@qq.com','Lavoratore','alto');
...
-- Dump completed on 2020-09-01 11:01:20
